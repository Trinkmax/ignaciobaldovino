...
import { StoryProgress } from "@/components/mobile/story-progress";
...
export function Navbar() {
    ...
    useMotionValueEvent(scrollY, "change", (latest) => {
        ...
        // Hide navbar when scrolling down, show when scrolling up (only desktop)
        ...
        <React.Fragment>
            ...
            >
                ...
                <div className="container mx-auto px-5 md:px-6 h-16 flex items-center justify-between">
                    <Link href="#hero" className="flex items-center space-x-2 group relative z-10">
                        <Image
                            src="/brand/IB-2.png"
                            alt="IB Consultoría"
                            width={30}
                        ...
                        />
                        <span className="font-mono text-base sm:text-lg font-bold tracking-tighter">
                            I.B.
                        </span>
                    </Link>
